...
const ApprovedByClientPage = () => {
  ...
  useEffect(() => {
    const ApprovedByClient = async () => {
      try {
        const res = await axios.get(`${url}/projects/approved-by-client`);
        console.log("aproved ka data", res.data);
  ...
  const handlerInvoiceRaised = async () => {
    ...
    try {
      ...
      toast.success("Projects Invoice Raised successfully");
