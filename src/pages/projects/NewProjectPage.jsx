...
const NewProjectPage = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        const res = await axios.get(`${url}/projects/new`);
        console.log("data aaya newprojectpage", res.data);
        const newProjectsOnly = res.data.filter(p => p.status === 'New');
        setProjects(newProjectsOnly); // yaha pe pura data set ho raha
      } catch (error) {
        console.error('Error sending projects to CEO:', error);
