...
//       console.log("data aaya", res.data);
//       setProjects(res.data.projects);     // Already paginated + filtered
//       setTotalItems(res.data.totalItems); // Total for pagination
//     } catch (error) {
...
// useEffect(() => {
//   fetchProjects();
// }, [currentPage]); // run on page or search change
